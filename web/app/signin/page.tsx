    ...
    <main className="signin-shell">
      <div className="signin-card">
          ...
          <div className="signin-stats">
            {stats.map((s) => (
              <div className="signin-stat" key={s.label}>
                ...
                <p className="metric-num" style={{ fontSize: "1.5rem" }}>{s.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="signin-right">
          <div>
            <div className="heading" style={{ marginBottom: 4 }}>Sign in to Maze</div>
            <p className="subtext" style={{ fontSize: "0.86rem" }}>Enter your workspace credentials to continue.</p>
          </div>
